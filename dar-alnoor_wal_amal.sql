...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 21, 2019 at 03:47 PM
...
--
-- Table structure for table `inventory_income_details`
--

DROP TABLE IF EXISTS `inventory_income_details`;
CREATE TABLE IF NOT EXISTS `inventory_income_details` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `inventory_income_reason`
--

DROP TABLE IF EXISTS `inventory_income_reason`;
CREATE TABLE IF NOT EXISTS `inventory_income_reason` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `inventory_income_table`
--

DROP TABLE IF EXISTS `inventory_income_table`;
CREATE TABLE IF NOT EXISTS `inventory_income_table` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Receipt_No` int(11) NOT NULL,
  `Rcp_Date` date NOT NULL,
  `Inventory_Reason_ID` int(11) NOT NULL,
  `Comment` text NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `Inventory_Income_Details` (`Inventory_Reason_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `order_details` (
  ...
  `Product_ID` int(11) NOT NULL,
  `Amount_Per_Product` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `Product_ID` (`Product_ID`),
